...
abstract class AbstractDriver {
	...
	def handleBrokenDictHierarchy(hierarchy:Array[PyString], i:Int, curDepth:PyObject, retVal:PyObject) = {
	...
	def recurseDictLayer(dict:PyObject, hierarchy:Array[PyString],depth:Int, dictProbe:(PyDictionary, Array[PyString], Int) => PyObject):Option[PyObject] = {
		dict match {
			case d:PyDictionary =>

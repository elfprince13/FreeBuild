...
class Texture(reqID:Int=0, reqTarget:Int=GL11.GL_TEXTURE_2D) {
	...
	def allocate2D(level:Int, fmt:Int, width:Int, height:Int, border:Int, format:Int, ttype:Int, offset:Option[Long]=None){
	  offset match {
	    case Some(ofs) => GL11.glTexImage2D(target,level,fmt,width,height,border,format,ttype,ofs)
	    case None => ttype match {
	      case GL11.GL_BYTE | GL11.GL_UNSIGNED_BYTE
	      | GL12.GL_UNSIGNED_BYTE_3_3_2 | GL12.GL_UNSIGNED_BYTE_2_3_3_REV
	      	=> GL11.glTexImage2D(target,level,fmt,width,height,border,format,ttype,null.asInstanceOf[ByteBuffer])
	      ...
	      | GL12.GL_UNSIGNED_SHORT_5_5_5_1 | GL12.GL_UNSIGNED_SHORT_1_5_5_5_REV
	      	=> GL11.glTexImage2D(target,level,fmt,width,height,border,format,ttype,null.asInstanceOf[ShortBuffer])
	      ...
	      | GL12.GL_UNSIGNED_INT_10_10_10_2 | GL12.GL_UNSIGNED_INT_2_10_10_10_REV
	      	=> GL11.glTexImage2D(target,level,fmt,width,height,border,format,ttype,null.asInstanceOf[IntBuffer])
	      case GL11.GL_FLOAT
	      	=> GL11.glTexImage2D(target,level,fmt,width,height,border,format,ttype,null.asInstanceOf[FloatBuffer])
